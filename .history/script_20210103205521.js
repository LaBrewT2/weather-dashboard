...
function showt(data){
  ...
  "<h3><strong>Weather</strong>: "+ data.c.weather[0].description + "</h3>" +
  ...
  "<h3><strong>Current Wind Direction</strong>: "+ data.wind.direction + "</h3>"  +"<h3><strong>Weather</strong>: "+ data.daily.weather[0].main + "</h3>" +
