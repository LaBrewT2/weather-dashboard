$(document).ready(function(){
    ...
    $('#search').click(function(){
      ...
      if(city != ''){
        ...
        $.ajax({
              //API Call
              url: 'https://api.openweathermap.org/data/2.5/onecall?lat={lat}&lon={lon}&exclude={part}&appid={API key}' + city + "&units=imperial" + "&APPID=667a7ad2f064b0cc35a232f16bab9c8d",   
              type: "GET",
              dataType: "jsonp",
